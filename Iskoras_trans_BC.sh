...
# $2 Name of the Case, of the BC spinup run
...
cp /cluster/work/users/estherbe/archive/$2/rest/$3/$2.cpl.r.$3.nc /cluster/work/users/estherbe/noresm/$1/run
...
./xmlchange RUN_REFDIR=/cluster/work/users/estherbe/archive/$2/rest/$3
./xmlchange RUN_REFCASE=$2
./xmlchange RUN_REFDATE=$3
